class Presenter3 implements IPresenter { 
  ...
  void onSetup() {
    if ( state.img == null ) { 
      img = loadImage("../../../images/girl2.jpg");
  ...
  void onMouseMoved() { 
    if ( cm < 3 && selectRect != null && selectRect.x < mouseX && selectRect.y < mouseY && mouseX < selectRect.x+selectRect.w-1 && mouseY < selectRect.y+selectRect.h-1 ) { 
